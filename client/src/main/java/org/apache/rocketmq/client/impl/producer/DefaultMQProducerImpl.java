...
public class DefaultMQProducerImpl implements MQProducerInner {
            ...
            for (; times < timesTotal; times++) {
                ...
                if (mqSelected != null) {
                    ...
                    try {
                        ...
                        //todo @Toby 【producer-2】发送netty请求
    ...
    private SendResult sendKernelImpl(final Message msg,
        ...
        if (brokerAddr != null) {
            ...
            try {
                ...
                //todo @Toby 【producer-5】组装netty请求信息，包括请求code和请求体，核心字段：topic、queueId、batch、brokerName
    ...
    public boolean hasSendMessendMessageBsageHook() {
