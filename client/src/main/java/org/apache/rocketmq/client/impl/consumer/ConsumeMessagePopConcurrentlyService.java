...
public class ConsumeMessagePopConcurrentlyService implements ConsumeMessageService {
    ...
    public void submitPopConsumeRequest(
        ...
        if (msgs.size() <= consumeBatchSize) {
            ...
            try {
                //todo @Toby 【pop消费-异步拉取消息】 拉取结果回调，将结果提交到消费线程池进行消费， this.consumeExecutor.submit(consumeRequest);
    ...
    public void processConsumeResult(
        ...
        //todo @Toby  【pop消费-消费失败-则提交偏移量】 this.defaultMQPushConsumerImpl.ackAsync
        ...
        for (int i = ackIndex + 1; i < consumeRequest.getMsgs().size(); i++) {
            ...
            //todo @Toby  【pop消费-消费失败-则更改可见时间】changePopInvisibleTime，最终触发ChangeInvisibleTimeProcessor
    ...
    class ConsumeRequest implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                //todo @Toby 【pop消费-异步拉取回调后-业务处理】 listener.consumeMessage
            ...
            //todo @Toby 【pop消费-异步拉取回调后-处理业务消费结果】 processConsumeResult
