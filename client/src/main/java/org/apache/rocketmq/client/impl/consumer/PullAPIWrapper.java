...
public class PullAPIWrapper {
    ...
    public PullResult pullKernelImpl(
        ...
        if (findBrokerResult != null) {
            ...
            //todo @Toby 【consumer-5.3.3】发送PullMessageRequestHeader请求，请求code=RequestCode.PULL_MESSAGE
            ...
            //todo @Toby 【consumer-5.3.5】发送netty请求入口
    ...
    public void popAsync(MessageQueue mq, long invisibleTime, int maxNums, String consumerGroup,
        ...
        if (findBrokerResult != null) {
            ...
            //todo @Toby 【pop消费-异步拉取消息】 发送pop请求：RequestCode.POP_MESSAGE请求
