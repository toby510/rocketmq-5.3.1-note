...
public class BrokerStartup {
    ...
    public static void main(String[] args) {
        //todo @Toby 【broker-0-启动入口】
        start(createBrokerController(args));
    }

    public static BrokerController start(BrokerController controller) {
        try {
            //todo @Toby 【broker-2-start启动】
            controller.start();
    ...
    public static BrokerController buildBrokerController(String[] args) throws Exception {
        ...
        //todo @Toby 【broker-0-创建broker的配置类】
        ...
        //todo @Toby 【broker-0-获取namesrvAddr，即NameServer的地址，并进行校验】
        ...
        //todo @Toby 【broker-0-设置、校验brokerId】
        //todo 通过此配置可知BrokerId为0表示Master，非0表示Slave
        ...
        /*
         todo @Toby 【broker-0-设置高可用通信监听端口】
       ...
       // todo @Toby 【broker-0-实例化BrokerController，设置各种属性】创建netty远程服务，初始化Netty线程池，注册请求处理器，配置定时任务，用于扫描并移除不活跃的Broker等操作。
    ...
    public static BrokerController createBrokerController(String[] args) {
        try {
            //todo @Toby 【broker-0-实例化controller】
            BrokerController controller = buildBrokerController(args);

            //todo @Toby 【broker-1-初始化controller】
