...
public class ChangeInvisibleTimeProcessor implements NettyRequestProcessor {
    ...
    private RemotingCommand processRequest(final Channel channel, RemotingCommand request,
        ...
        //todo @Toby 【pop消费-更改可见时间-1】创建新的CK
        ...
        // ack old msg.
        try {
            //todo @Toby 【pop消费-更改可见时间-2】对pop消费时创建的CK进行ACK处理，避免创建重复的CK。AckMsg 的本质是 “失效指令”—— 通过 StartOffset 定位到旧 CK 在 reviveTopic 中的位置，告诉 Broker：“这条旧 CK 对应的状态已过期，无需再处理”。
